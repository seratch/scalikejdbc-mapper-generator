...
object UnNormalized {
  ...
  def create(v01: Byte, v02: Short, v03: Int, v04: Long, v05: BigDecimal, v06: BigDecimal, v07: Double, v08: Boolean, v09: String, v10: String, v11: Clob, v12: String, v13: Array[Byte], v14: Array[Byte], v15: Blob, v16: Boolean, v17: Date, v18: Date, v19: Date, v20: Date, v21: Any, v22: Boolean, v23: Double, v24: Double, createdAt: Date): UnNormalized = {
    DB localTx { implicit session =>
      val generatedKey = SQL("INSERT INTO UN_NORMALIZED (V_01, V_02, V_03, V_04, V_05, V_06, V_07, V_08, V_09, V_10, V_11, V_12, V_13, V_14, V_15, V_16, V_17, V_18, V_19, V_20, V_21, V_22, V_23, V_24, CREATED_AT) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)")
        .bind(v01, v02, v03, v04, v05, v06, v07, v08, v09, v10, v11, v12, v13, v14, v15, v16, v17, v18, v19, v20, v21, v22, v23, v24, createdAt).updateAndReturnGeneratedKey.apply()
      val m = new UnNormalized
      m.id = generatedKey
      m.v01 = v01
      m.v02 = v02
  ...
  def save(m: UnNormalized): Unit = {
    DB localTx { implicit session =>
      SQL("UPDATE UN_NORMALIZED SET ID = ?, V_01 = ?, V_02 = ?, V_03 = ?, V_04 = ?, V_05 = ?, V_06 = ?, V_07 = ?, V_08 = ?, V_09 = ?, V_10 = ?, V_11 = ?, V_12 = ?, V_13 = ?, V_14 = ?, V_15 = ?, V_16 = ?, V_17 = ?, V_18 = ?, V_19 = ?, V_20 = ?, V_21 = ?, V_22 = ?, V_23 = ?, V_24 = ?, CREATED_AT = ? WHERE ID = ?")
        .bind(m.id, m.v01, m.v02, m.v03, m.v04, m.v05, m.v06, m.v07, m.v08, m.v09, m.v10, m.v11, m.v12, m.v13, m.v14, m.v15, m.v16, m.v17, m.v18, m.v19, m.v20, m.v21, m.v22, m.v23, m.v24, m.createdAt, m.id).update.apply()
    }
  }
