...
class UnNormalized(
    ...
    val v10: String,
    val v11: Option[String] = None,
    val v12: Option[String] = None,
    val v13: Option[String] = None,
    val v14: Option[String] = None,
    val v15: Option[String] = None,
    val v16: Boolean,
    val v17: LocalDate,
    val v18: LocalTime,
    val v19: LocalTime,
  ...
  def copy(
    ...
    v07: Double = this.v07,
    v08: Boolean = this.v08,
    v09: Option[String] = this.v09,
    v10: String = this.v10,
    v11: Option[String] = this.v11,
    v12: Option[String] = this.v12,
    v13: Option[String] = this.v13,
    v14: Option[String] = this.v14,
    v15: Option[String] = this.v15,
    v16: Boolean = this.v16,
...
object UnNormalized {
  ...
  val * = {
    ...
    (rs: WrappedResultSet) => new UnNormalized(
      ...
      v03 = rs.int(v03),
      v04 = rs.long(v04),
      v05 = rs.bigDecimal(v05),
      v06 = rs.bigDecimal(v06),
      v07 = rs.double(v07),
      v08 = rs.boolean(v08),
      v09 = Option(rs.string(v09)),
      v10 = rs.string(v10),
      v11 = Option(rs.string(v11)),
      v12 = Option(rs.string(v12)),
      v13 = Option(rs.string(v13)),
      v14 = Option(rs.string(v14)),
      v15 = Option(rs.string(v15)),
      v16 = rs.boolean(v16),
